...
See `V022_V026_SURVIVAL_VISUAL_ROADMAP.md` and `V022_RELEASE_VALIDATION.md`. V0.22 brings an original procedural Galaxy backdrop to actual Survival/Endless combat, cached nebula, depth-layer stars, reduced-motion support and bounded mobile rendering. V0.23: combat hit/cast FX. V0.24: individual skill visual identity. V0.25: high-tier spectacle. V0.26: polish/optimization. Each release requires user testing on Pages.
