...
assert(index.includes('js/skill-codex.js?v=016dev-base80-r1'),'Codex script must use the V0.16 development cache key');
assert(index.indexOf('js/v016-skills-a4.js?v=016dev-base80-r1')<index.indexOf('js/skill-codex.js?v=016dev-base80-r1'),'All V0.16 base skills must register before the Codex script loads');
...
console.log('V0.16 base80 integration smoke test passed');
