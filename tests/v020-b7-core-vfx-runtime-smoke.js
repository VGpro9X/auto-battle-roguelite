...
assert(html.includes("'js/renderer-v3.js?v=020-b7','js/duel-vfx-v3.js?v=020-b12a','js/duel-renderer-v3-bridge.js?v=020-b13b'")||html.includes("'js/renderer-v3.js?v=020-b7','js/duel-vfx-v3.js?v=020-b7','js/duel-renderer-v3-bridge.js?v=020-b7'"),'B7 bootstrap load order invalid');
