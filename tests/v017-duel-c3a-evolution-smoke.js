...
const uiLoader=fs.readFileSync('js/duel-ui.js','utf8');
const ui=fs.readFileSync('js/duel-ui-v020.js','utf8');
assert.ok(uiLoader.includes('duel-ui-v020.js'));
assert.ok(ui.includes('getDuelEvolutionChoiceHints'));
assert.ok(ui.includes('MỞ SIÊU CẤP'));
