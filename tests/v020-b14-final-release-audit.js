...
assert(core.includes('const GAME_VERSION="V0.20";')||core.includes('const GAME_VERSION="V0.21";'),"runtime GAME_VERSION must preserve V0.20 or advance to V0.21");
assert(html.includes("<title>Auto Battle Roguelite V0.20</title>")||html.includes("<title>Auto Battle Roguelite V0.21</title>"),"public title must preserve V0.20 or advance to V0.21");
assert(html.includes('<div id="version">Auto Battle Roguelite V0.20</div>')||html.includes('<div id="version">Auto Battle Roguelite V0.21</div>'),"public version badge must preserve V0.20 or advance to V0.21");
assert(uiSync.includes("V0.20 · ĐẤU TRƯỜNG 1V1")||uiSync.includes("V0.21 · ĐẤU TRƯỜNG 1V1"),"Duel UI sync label must preserve V0.20 or advance to V0.21");
assert(duelUi.includes("V0.20 · ĐẤU TRƯỜNG 1V1")||duelUi.includes("V0.21 · ĐẤU TRƯỜNG 1V1"),"Duel lobby label must preserve V0.20 or advance to V0.21");
assert(html.includes("js/core.js?v=020-release-r1")||html.includes("js/core.js?v=021-release-r1"),"current core cache key missing");
assert(html.includes("js/duel-ui-sync.js?v=020-release-r1")||html.includes("js/duel-ui-sync.js?v=021-release-r1"),"current Duel UI sync cache key missing");
