...
const v020Tag='<script src="js/v020-enemy-presentation.js?v=020-b4"></script>';
const v014Pos=index.indexOf(v014Tag),v020Pos=index.indexOf(v020Tag);
...
const between=index.slice(v014Pos+v014Tag.length,v020Pos).trim();
assert(between==='',`unexpected runtime inserted between V0.14 and V0.20 enemy presentation: ${between.slice(0,80)}`);
