...
assert(index.includes('<script src="js/v014-character-enemy-presentation.js"></script>\n<script src="js/v020-enemy-presentation.js?v=020-b4"></script>'),'B4 runtime must load immediately after V0.14 presentation');
