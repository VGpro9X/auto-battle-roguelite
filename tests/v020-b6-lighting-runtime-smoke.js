...
for(const forbidden of ['duelDealDamage(','spawnDuelProjectile(','target.hp-=','target.x=','round.phase='])assert(!bridge.includes(forbidden),'lighting bridge must not own simulation truth: '+forbidden);
